...
[TestClass]
public class FlooringRounderTests : TestFixture<FlooringRounder>
{
    [TestMethod]
    ...
    [TestMethod]
    public void Round_Decimal4_NoDecimals_IsRoundedDown()
    {
        var input = 1.4m;
        var actual = this.Target.Round(input);
        Assert.AreEqual(1m, actual);
    ...
    [TestMethod]
    public void Round_Decimal5_NoDecimals_IsRoundedDown()
    {
        var input = 1.5m;
        var actual = this.Target.Round(input);
        Assert.AreEqual(1m, actual);
